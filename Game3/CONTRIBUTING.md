# 🤝 Contributing to Snake & Ladder

First off, thank you for considering contributing to Snake & Ladder! It's people like you that make this project better for everyone.
...
```html
<!-- ✅ Good -->
<button id="rollDiceBtn" aria-label="Roll the dice">
    Roll Dice
</button>
